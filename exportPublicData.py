...
addCmd = ["git", "--git-dir=" + output_path + "/.git", "add", "."]
gitAdd = Popen(addCmd, stdin=PIPE)
gitAdd.communicate()
commitCmd = ["git", "--git-dir=" + output_path + "/.git", "commit", "-m", "modified collections exported from ArchivesSpace"]
gitCommit = Popen(commitCmd, stdin=PIPE)
gitCommit.communicate()
pushCmd = ["git", "--git-dir=" + output_path + "/.git", "push", "origin", "master"]
